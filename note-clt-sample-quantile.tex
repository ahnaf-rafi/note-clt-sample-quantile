...
\addbibresource{note-clt-sample-quantile.bib}

\title{A note on asymptotic normality of sample quantiles}
\author{Ahnaf Rafi}
\date{\today}
...
\input{sections/prf-main-cor.tex}
\input{sections/prf-main-thm.tex}
\input{sections/cdf-behavior.tex}
\input{sections/prf-bin-clt-normal.tex}
